"""
Django settings for comaf project.
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    #'comaf.apps.base.context_processors.google_analytics',
)
...
if DEBUG:
    LOGGING['loggers']['comaf']['level'] = 'DEBUG'
...
COMPRESS_PRECOMPILERS = (
    ...
    ('text/less', 'comaf.precompilers.LessFilter'),
)
